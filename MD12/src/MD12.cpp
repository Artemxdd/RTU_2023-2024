...
public:
    ArithmeticalOperations(std::string numberOne, std::string numberTwo) {
...
int main() {
    ...
    std::cout << "Enter Number 1! Number 1 = ";
    std::getline(std::cin, numberOne);
    std::cout << "Enter Number 2! Number 2 = ";
    std::getline(std::cin, numberTwo);
    std::cout << "\n";

    ArithmeticalOperations arithmeticalOperations(numberOne, numberTwo);
    arithmeticalOperations.showAllInfo();
}